...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="lastName">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="lastName" class="form-control" placeholder="Family name"
                            autofocus="true"></form:input>
        ...
        <spring:bind path="pass">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="pass" path="pass" class="form-control" placeholder="Password"></form:input>
        ...
        <spring:bind path="passwordConfirm">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="pass" path="passwordConfirm" class="form-control"
                            placeholder="Confirm your pass"></form:input>
